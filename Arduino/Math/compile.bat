cls
"D:\Arduino\arduino_1.8.3\hardware\tools\avr\bin\avr-as" -mmcu=atmega328p system\math\add.s system\math\sub.s system\math\mul.s system\math\div.s -o tmp\math.o
